...
class SocialResult extends StatelessWidget {
  const SocialResult(this.holder, this.resultScore, {Key key}) : super(key: key);
  ...
  String get resultPhrase {
    String resultText = '';
    if (resultScore >= 80) {
      resultText = 'You Are Very social!';
    } else if (resultScore >= 60) {
      resultText = 'You Are social!';
    } else if (resultScore >= 40){
      resultText = 'You Are Natural social!';
    }else if(resultScore >= 20){
      resultText = 'You Are Not Very social!';
    }else {
      resultText = 'You Are Not social!';
    }
              ...
              children: [
                ...
                MaterialButton(
                  ...
                  onPressed: () {
                    ...
                    PeaCubit.get(context).createSocialScore(
                        score: resultScore,
                      dateTime: now
                    );
                  },
